...
const cleanContent = `import fs from 'node:fs/promises';
...
fs.writeFileSync('scripts/procedural-blogs.ts', cleanContent);
console.log('Clean procedural script written.');
